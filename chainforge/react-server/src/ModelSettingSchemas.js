  ...
  schema: {
    "type": "object",
      ...
      "use_cache": {
        "type": "boolean",
        "title": "use_cache",
        "description": "Whether to use cached completions. If true, the model will return a cached completion if one is available. If false, the model will always generate a new completion.",
        "default": true
      }
    }
  },
...
export const postProcessFormData = (settingsSpec, formData) => {
  ...
  const skip_keys = {'model': true, 'shortname': true, 'use_cache': true};
